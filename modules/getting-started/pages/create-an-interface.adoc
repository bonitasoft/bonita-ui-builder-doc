= Create an interface
:page-aliases: 2024.3@bonita:applications:ui-builder/create-an-interface.adoc, 2025.1@bonita:applications:ui-builder/create-an-interface.adoc, 2025.2@bonita:applications:ui-builder/create-an-interface.adoc
...
On this page, we will try to create a form where customers can submit a claim. This is inspired by the Getting Started tutorial's xref:@bonita:getting-started:create-web-user-interfaces.adoc[example].


== Prerequisites 
* Bonita UI Builder downloaded and launched
* A working Bonita project with a defined process diagram, BDM, and contract. Follow the xref:@bonita:getting-started:getting-started-index.adoc[Getting Started tutorial] if you need any help
...
image:design-interface.png[design-interface]
