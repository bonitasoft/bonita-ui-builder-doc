...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-create-editable-tables.adoc, 2025.1@bonita:applications:ui-builder/how-to-create-editable-tables.adoc, 2025.2@bonita:applications:ui-builder/how-to-create-editable-tables.adoc
...
image:multiplication.gif[multiplication]
...
image:background_color.gif[background_color]
...
image:tick_editable.png[tick_editable]
...
image:onsave_table.gif[onsave_table]
...
image:refresh_table.png[refresh_table]
