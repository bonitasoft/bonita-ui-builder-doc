...
:page-aliases: 2024.3@bonita:applications:ui-builder/version-control-with-git/connect-git.adoc, 2025.1@bonita:applications:ui-builder/version-control-with-git/connect-git.adoc, 2025.2@bonita:applications:ui-builder/version-control-with-git/connect-git.adoc
...
* xref:git-settings.adoc[Git Settings]
