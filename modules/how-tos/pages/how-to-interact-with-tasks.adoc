= Interact with tasks
:page-aliases: ROOT:how-to-interact-with-tasks.adoc
...
Here, we will create a modal that will execute the "Review and answer claim" task from the xref:{bonitaVersion}@bonita:getting-started:create-web-user-interfaces.adoc[Getting Started] tutorial. The modal should look like this:
