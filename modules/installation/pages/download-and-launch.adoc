...
:page-aliases: 2024.3@bonita:applications:ui-builder/download-and-launch.adoc, 2025.1@bonita:applications:ui-builder/download-and-launch.adoc, 2025.2@bonita:applications:ui-builder/download-and-launch.adoc
...
[NOTE]
====
*macOS users*: If you plan to launch UI Builder from Bonita Studio, additional Keychain configuration is required.
See the xref:bonita:software-extensibility:bonita-repository-access.adoc#docker-configuration[macOS specific
...
[TIP]
====
If encountering issues with Windows and WSL, check our xref:ROOT:faq.adoc#WSLissue[FAQ] .
====
