= FAQ
:page-aliases: 2024.3@bonita:applications:ui-builder/faq.adoc, 2025.1@bonita:applications:ui-builder/faq.adoc, 2025.2@bonita:applications:ui-builder/faq.adoc
...
=== How to use?
[subs=+macros]
You can easily test a xref:development:development-instance-from-studio.adoc[Development instance from Studio]. +
