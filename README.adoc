...
This repository contains the sources of the https://documentation.ofelia.com/uib[UI Builder documentation site]. It
uses https://docs.asciidoctor.org/asciidoc/latest/[AsciiDoc] format for the documentation content.
...
== Providing feedbacks about Bonita UI Builder product
