...
:page-aliases: 2024.3@bonita:applications:ui-builder/builder-declare-interface-in-bonita.adoc, 2025.1@bonita:applications:ui-builder/builder-declare-interface-in-bonita.adoc, 2025.2@bonita:applications:ui-builder/builder-declare-interface-in-bonita.adoc
...
The xref:@bonita:applications:ui-designer/application-creation.adoc[Bonita application descriptor] is a file that let you describe all your applications.
...
image:application-link-descriptor.png[Application Descriptor Editor]
...
The `token` property's value must be identical to the value of the `slug` key found in the xref:deployment:package-and-deploy-your-application.adoc#export-application[JSON export of your application]. For example, if your application name is __Awesome application__, its `slug` should be __awesome-application__.
