...
:page-aliases: 2025.1@@bonita:applications:ui-builder/how-to-manage-bdm-data.adoc, 2025.2@@bonita:applications:ui-builder/how-to-manage-bdm-data.adoc
...
[NOTE]
====
This guide relies on features available starting from Bonita *2025.1*.
====
