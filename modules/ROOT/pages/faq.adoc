...
=== How to use?
[subs=+macros]
Please refer to the xref:getting-started:initiation-manual.adoc[initiation manual]. If you have any other additional questions, reach out to our {cscRootUrl}[Support team].
