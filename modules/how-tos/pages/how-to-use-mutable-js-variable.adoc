...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-use-mutable-js-variable.adoc, 2025.1@bonita:applications:ui-builder/how-to-use-mutable-js-variable.adoc, 2025.2@bonita:applications:ui-builder/how-to-use-mutable-js-variable.adoc
