...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-upload-multiple-documents.adoc, 2025.1@bonita:applications:ui-builder/how-to-upload-multiple-documents.adoc, 2025.2@bonita:applications:ui-builder/how-to-upload-multiple-documents.adoc
...
image:file-picker-widget-properties.png[file-picker-widget-propeties]
...
image:query-formFileUpload.png[query-formFileUpload]
...
image:bind-file-upload.png[bind-file-upload]