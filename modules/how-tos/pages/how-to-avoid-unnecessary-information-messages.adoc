...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-avoid-unnecessary-information-messages.adoc, 2025.1@bonita:applications:ui-builder/how-to-avoid-unnecessary-information-messages.adoc, 2025.2@bonita:applications:ui-builder/how-to-avoid-unnecessary-information-messages.adoc
...
image:partially-imported.png[partially-imported]
...
image:run-on-page-load.png[run-on-page-load]
...
image:run-js-on-page-load.png[run-js-on-page-load]
