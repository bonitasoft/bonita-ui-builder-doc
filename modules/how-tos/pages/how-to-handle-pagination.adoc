...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-handle-pagination.adoc, 2025.1@bonita:applications:ui-builder/how-to-handle-pagination.adoc, 2025.2@bonita:applications:ui-builder/how-to-handle-pagination.adoc
:description: Learn how to handle server-side pagination and optimize performance

{description}

* Difficulty: beginner
* Prerequisites: have your interface xref:getting-started:interact-with-your-bonita-process.adoc[interact] with a Bonita process
...
image:pagination-input-widget.png[pagination-input-widget]

  
Configure the list widget:

image:pagination-list-widget.png[pagination-list-widget]
