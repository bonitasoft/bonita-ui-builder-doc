...
Bonita UI Builder Docker image is located in the xref:{bonitaVersion}@bonita:software-extensibility:bonita-repository-access.adoc[Bonita Artifact Repository].
