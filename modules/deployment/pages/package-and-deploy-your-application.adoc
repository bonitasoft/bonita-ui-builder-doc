...
:page-aliases: ROOT:package-and-deploy-your-application.adoc
...
[NOTE]
====
This strategy is the most common and recommended way to deploy your application in production. It allows you to be close with the xref:{bonitaVersion}@bonita:getting-started:package-and-deploy-sca-application.adoc[application packaging] strategy.
====
