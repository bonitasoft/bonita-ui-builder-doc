= Interact with tasks
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-interact-with-tasks.adoc, 2025.1@bonita:applications:ui-builder/how-to-interact-with-tasks.adoc, 2025.2@bonita:applications:ui-builder/how-to-interact-with-tasks.adoc
...
There are four Bonita xref:development:common-apis-to-use.adoc[API resources] you mostly need to interact with your tasks: 
...
image:execute_hr_mngt_task.png[execute_ht_mngt_task]
...
image:create_modal.png[create_modal]

Here, we will create a modal that will execute the "Review and answer claim" task from the xref:@bonita:getting-started:create-web-user-interfaces.adoc[Getting Started] tutorial. The modal should look like this:

image:modal_task.png[modal_task]
...
image:bind_confirm_modal.png[bind_confirm_modal]
