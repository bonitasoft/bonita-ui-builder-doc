...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-contract-with-multiple-attribute.adoc, 2025.1@bonita:applications:ui-builder/how-to-contract-with-multiple-attribute.adoc, 2025.2@bonita:applications:ui-builder/how-to-contract-with-multiple-attribute.adoc
...
image:adding-a-row-on-save.png[adding-a-row-on-save, 500]
...
image:table-save-discard-column.png[table-save-discard-column, 300]
