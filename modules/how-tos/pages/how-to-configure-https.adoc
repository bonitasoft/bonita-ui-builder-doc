= HTTPS Configuration
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-configure-https.adoc, 2025.1@bonita:applications:ui-builder/how-to-configure-https.adoc, 2025.2@bonita:applications:ui-builder/how-to-configure-https.adoc
...
If you deploy Bonita Runtime Tomcat bundle instead of the docker container, make sure you xref:@bonita:identity:ssl.adoc#_tomcat_and_ssl_offloading[activate the RemoteIpValve].
