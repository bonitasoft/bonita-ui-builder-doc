...
:page-aliases: 2024.3@bonita:applications:ui-builder/version-control-with-git/revert-changes.adoc, 2025.1@bonita:applications:ui-builder/version-control-with-git/revert-changes.adoc, 2025.2@bonita:applications:ui-builder/version-control-with-git/revert-changes.adoc
