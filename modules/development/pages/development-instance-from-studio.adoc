...
[WARNING]
====
On macOS, be sure to follow the xref:bonita@software-extensibility:bonita-repository-access
.adoc#macOS-configuration[specific configuration] to access to Bonita Artifact Repository.
====
