= Resources
:page-aliases: 2024.3@bonita:applications:ui-builder/resources.adoc, 2025.1@bonita:applications:ui-builder/resources.adoc, 2025.2@bonita:applications:ui-builder/resources.adoc
...
* xref:getting-started:initiation-manual.adoc[Initiation manual] to help you start from scratch and build your first application
* xref:how-tos:how-tos-builder.adoc[Guides] to facilitate your usage of Bonita UI Builder
* xref:faq.adoc[FAQ]
