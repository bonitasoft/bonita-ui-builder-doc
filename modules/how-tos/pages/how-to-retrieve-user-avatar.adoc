...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-retrieve-user-avatar.adoc, 2025.1@bonita:applications:ui-builder/how-to-retrieve-user-avatar.adoc, 2025.2@bonita:applications:ui-builder/how-to-retrieve-user-avatar.adoc
...
image:query-get-users.png[query-get-users]
...
image:user-list-widget.png[user-list-widget]
...
image:user-avatar.png[user-avatar]
