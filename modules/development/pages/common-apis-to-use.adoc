= Common APIs to use
:page-aliases: 2024.3@bonita:applications:ui-builder/common-apis-to-use.adoc, 2025.1@bonita:applications:ui-builder/common-apis-to-use.adoc, 2025.2@bonita:applications:ui-builder/common-apis-to-use.adoc
