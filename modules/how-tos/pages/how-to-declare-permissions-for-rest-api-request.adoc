...
:page-aliases: 2024.3@bonita:applications:ui-builder/how-to-declare-permissions-for-rest-api-request.adoc, 2025.1@bonita:applications:ui-builder/how-to-declare-permissions-for-rest-api-request.adoc, 2025.2@bonita:applications:ui-builder/how-to-declare-permissions-for-rest-api-request.adoc
...
With the setup tool, you can now xref:@bonita:ROOT:bonita-platform-setup.adoc#update_platform_conf[update the permissions configuration] in the database using the `setup.sh push` command.

=== Initial setup (before first startup)

If your Bonita platform has never been started, you can configure the permissions in the  `/bonita/setup/platform_conf/initial` folder to update the xref:@bonita:ROOT:bonita-platform-setup.adoc#init_platform_conf[initial configuration].
