...
[NOTE]
====
This documentation corresponds to the {page-component-version} of Bonita UI Builder, which is pass:a[{bonita-ui-builder-version}].
See the xref:release-notes.adoc[release notes] for more information.
====
...
Bonita UI Builder is a standalone product available as a custom Docker image, which can be downloaded from the xref:{bonitaVersion}@bonita:software-extensibility:bonita-repository-access.adoc[Bonita Artifact Repository]. It also requires a 2024.3 Enterprise version of Bonita (or any later version) to work.
...
Bonita also comes with four xref:{bonitaVersion}@bonita:runtime:bonita-applications-interface-overview.adoc[Bonita Applications].
...
"Applications" need to be defined via an `applicationLink` tag in the xref:getting-started:builder-declare-interface-in-bonita.adoc[Application descriptor].
...
If you haven’t subscribed to a Scale or Access plan yet, please https://www.ofelia.com/contact-us[get in touch] with our sales team to start your journey today!
...
[.card.card-index]
--
xref:getting-started:initiation-manual.adoc[[.card-title]#Initiation manual# [.card-body.card-content-overflow]#pass:q[Steps to download and use Bonita UI Builder]#]
--

[.card.card-index]
--
xref:git:version-control-with-git.adoc[[.card-title]#Version control with Git# [.card-body
.card-content-overflow]#pass:q[Learn how to effectively collaborate on your Bonita UI Builder projects.]#]
--

[.card.card-index]
--
xref:how-tos:how-tos-builder.adoc[[.card-title]#Guides# [.card-body.card-content-overflow]#pass:q[Guides to make the most of
 Bonita UI Builder]#]
--
...
Bonita UI Builder is commercially licensed and has Copyright (c) 2024 Ofelia. All rights reserved.
