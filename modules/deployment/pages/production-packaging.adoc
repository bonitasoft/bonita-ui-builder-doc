...
:page-aliases: 2024.3@bonita:applications:ui-builder/production-packaging.adoc, 2025.1@bonita:applications:ui-builder/production-packaging.adoc, 2025.2@bonita:applications:ui-builder/production-packaging.adoc
...
[source,docker,subs="+macros,+attributes"]
----
include::examples$production/docker-compose.yml[]
----
...
The xref:@bonita:runtime:healthcheck-mechanism.adoc[Bonita healthcheck] is a mechanism used to monitor the health and availability of Bonita services in production environments.
...
You can override and configure all xref:installation:ui-builder-docker-installation.adoc#environment-variables[environment variables].
