...
The xref:{bonitaVersion}@bonita:applications:ui-designer/application-creation.adoc[Bonita application descriptor] is a file that let you describe all your applications.
